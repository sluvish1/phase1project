...
document.getElementById("upDoBookingButton").addEventListener
(`click`, () => alert(`hello govna`))

document.getElementById("braidedPonytailBookingButton").addEventListener
(`click`, () => alert(`hello govna`))


document.getElementById("heartBunBookingButton").addEventListener
(`click`, () => alert(`hello govna`))


document.getElementById("pigtailsBookingButton").addEventListener
(`click`, () => alert(`hello govna`))
